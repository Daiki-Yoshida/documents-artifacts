...
DESIGN_PHILOSOPHY.md:
  owns:
    ...
    - "Concept Altitude: YAGNI bounds mechanism, not meaning; the first consumer is not the owner (the WHY)"
...
CODING_STANDARDS.md:
  owns:
    ...
    - "Concept Generality rule (consumer-neutral naming & types; feature-policy placement)"
...
AI_WORKFLOW.md:
  owns:
    ...
    - "Pre-implementation scan (module-sense resolution / module shell & horizon / responsibility / concept altitude / dependency spread / mapping / accuracy-vs-speed)"
