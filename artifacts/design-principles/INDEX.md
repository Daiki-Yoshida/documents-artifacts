...
AI_WORKFLOW.md:
  owns:
    ...
    - "Pre-implementation scan (task outcome / module shell & horizon / responsibility / concept altitude + semantic identity / state ownership + consistency / dependency spread / mapping / accuracy-vs-speed)"
