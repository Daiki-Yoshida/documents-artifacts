...
WORKSPACE_STRUCTURE.md:
  owns:
    ...
    - "Repository selector, path derivation, and repository-specific Work Identity/branch mapping"
...
ENVIRONMENT_WORKFLOW.md:
  owns:
    ...
    - "Checkout and optional Git worktree lifecycle, including preflight, atomic creation/recreation, postconditions, rollback, and removal"
