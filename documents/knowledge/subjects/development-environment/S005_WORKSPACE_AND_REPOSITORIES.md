# 開発環境 — WorkspaceとRepository

Workspace Repository / Component Repository、top-level構造、Git管理境界、複数component、workspace tool dependencyを扱う。Work Identity固有のWork Root/worktree構造は別subjectが所有する。
