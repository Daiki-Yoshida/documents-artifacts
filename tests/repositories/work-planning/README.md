...
environment for a given work identity. The identity is a `<name>` or
`<type>/<name>` string using lowercase letters, digits, and hyphens —
for example `feat/audit-log-export`:
